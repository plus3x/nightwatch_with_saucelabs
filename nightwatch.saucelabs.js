...
module.exports = {
  ...
  test_settings: {
    ...
    macos_10_11_safari_9_0:   desired_capabilities( 'OS X 10.11',            'safari',  '9.0', 'macos_10_11_safari_9_0'),
    ...
    linux_chrome_48_0:        desired_capabilities(       'Linux',           'chrome', '48.0', 'linux_chrome_48_0'),
    linux_chrome_47_0:        desired_capabilities(       'Linux',           'chrome', '47.0', 'linux_chrome_47_0'),
    linux_firefox_45_0:       desired_capabilities(       'Linux',          'firefox', '45.0', 'linux_firefox_45_0'),
    linux_firefox_44_0:       desired_capabilities(       'Linux',          'firefox', '44.0', 'linux_firefox_44_0'),
